...
- Druhé kolo: potvrzení z e-mailu školy vede na `/pro-reditele?confirm=` a odemyká až tlačítkem (POST), aby ho skenery pošty „nevyklikaly“; přesun členství přes kód zachová aktivaci učitele.
