import{f as yt,r as n,p as je,b as fe,j as e,L as wt,m as U,t as Ie,_ as jt,A as ke,n as kt,e as Nt,h as St,l as ct,z as zt,i as Be,k as Ct,N as Ft}from"./index-C6KjhRJo.js";import{a as Dt,W as $t}from"./WebinarCard-BgBbUkyS.js";import{S as Le,w as Te}from"./SEOHead-COCOpFKC.js";import{T as Pt,S as Et,s as _t}from"./TrialPage-CE0eci5X.js";import{i as He,a as Qe}from"./emailValidation-zWHvJ6yV.js";import{C as dt}from"./circle-check-big-CpSwZTzH.js";import{E as Rt}from"./external-link-CvJ0G5mO.js";import{C as At}from"./clock-Bt8_mGG1.js";import{L as ce}from"./loader-circle-NQtHEaRL.js";import{C as pt}from"./circle-alert-Dpm0nnk0.js";import{g as mt,a as xt,w as It,b as Bt,c as Lt}from"./webinarSurveyDefaults-4Jc6LAJj.js";import{l as Tt}from"./svg-fupfguvmdt-BJftoE9y.js";import{A as Ot}from"./award-dTZUlpQi.js";import{D as Vt}from"./download-ByMsWxX5.js";import{C as Fe}from"./chevron-left-CC1pH5hF.js";import{C as Ae}from"./chevron-right-2iRarqk8.js";import{C as Mt}from"./clipboard-list-xTp6aS2E.js";import{C as Ut}from"./check-CjT0WL4y.js";import{S as ut}from"./search-x2zfkzgZ.js";import{B as ft}from"./building-2-DtMLCQwe.js";import{l as Oe,r as Wt}from"./dvppSavedContacts-B9FJeLoK.js";import{C as Gt}from"./calendar-tor6iyWv.js";import"./ImageWithFallback-Dc4XOooj.js";import"./play-BQZdWnV2.js";import"./user-BobFRFJI.js";import"./message-circle-CQA-qpKd.js";import"./mail-avX1BLVh.js";import"./phone-CHuiVL1R.js";import"./users-C581GB47.js";import"./sparkles-DCdfHjJd.js";import"./book-open-DNPRaiac.js";/**
 * @license lucide-react v0.487.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ht=[["path",{d:"M10.3 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2v10l-3.1-3.1a2 2 0 0 0-2.814.014L6 21",key:"9csbqa"}],["path",{d:"m14 19 3 3v-5.5",key:"9ldu5r"}],["path",{d:"m17 22 3-3",key:"1nkfve"}],["circle",{cx:"9",cy:"9",r:"2",key:"af1f0g"}]],Je=yt("image-down",Ht),Ve=`https://${je}.supabase.co/functions/v1/make-server-93a20b6f`,Q={fontFamily:"'Fenomen Sans', sans-serif"};function Qt(t){return/Učitel|Pedagogický/i.test(t)}function Jt(t){return{name:t.name.trim(),email:t.email.trim(),phone:t.phone.trim(),position:t.position,schoolName:t.schoolName.trim(),vat:t.ico.replace(/\D/g,"").slice(0,10),gdpr:t.gdpr,newsletter:t.newsletter,teacherSubjects:Qt(t.position)?["Other-2"]:[],schoolStages:[]}}function Zt({form:t,notTeacher:s}){const[o,x]=n.useState(null),[l,j]=n.useState(""),[E,D]=n.useState(!1),[L,k]=n.useState([]),[N,c]=n.useState(null),[z,y]=n.useState([]),[F,d]=n.useState(!1),[f,p]=n.useState(null),[u,i]=n.useState(null),[I,m]=n.useState(!1),[b,J]=n.useState(null),[W,Z]=n.useState(!1),[G,T]=n.useState(""),S=t.ico.replace(/\D/g,"").slice(0,10),C=(o==="active_subscription"||o==="active_trial"||o==="in_progress")&&!!l&&!E,g=F&&!E&&!C&&o!=="unknown"&&o!=="invalid"&&o!==null&&S.length>=6,v=n.useMemo(()=>{if(!f)return null;const $=new Date(f);return Number.isNaN($.getTime())?null:{dateStr:$.toLocaleDateString("cs-CZ",{day:"numeric",month:"long",year:"numeric"}),daysLeft:Math.max(0,Math.ceil(($.getTime()-Date.now())/(1e3*60*60*24)))}},[f]),_=n.useRef(null);n.useEffect(()=>{if(s||S.length<6){x(null),j(""),k([]),c(null),y([]),d(!1),p(null);return}_.current&&clearTimeout(_.current),_.current=setTimeout(async()=>{D(!0);try{const A=await(await fetch(`${Ve}/school-pipedrive-check?ico=${encodeURIComponent(S)}`,{headers:{Authorization:`Bearer ${fe}`}})).json();x(A.status||"unknown"),j(typeof A.message=="string"?A.message:""),k(Array.isArray(A.colleagues)?A.colleagues:[]),c(A.owner??null),y(Array.isArray(A.products)?A.products:[]),d(!!A.trialCooldownActive),p(typeof A.trialNextEligibleAt=="string"?A.trialNextEligibleAt:null)}catch{x("unknown"),j(""),k([]),c(null),y([]),d(!1),p(null)}finally{D(!1)}},600)},[S,s]);const R=n.useRef(null);n.useEffect(()=>{const $=t.email.trim();if(s||!$||!He($)){i(null);return}R.current&&clearTimeout(R.current),R.current=setTimeout(async()=>{m(!0);try{const A=await fetch(`${Ve}/check-trial-email?email=${encodeURIComponent($)}`,{headers:{Authorization:`Bearer ${fe}`}});i(await A.json())}catch{i(null)}finally{m(!1)}},400)},[t.email,s]);const h=async()=>{if(!(C||g)){if(!t.gdpr){T("Chybí souhlas se zpracováním údajů z registrace.");return}if(u?.emailInvalid&&u.message){T(u.message);return}if(u&&!u.canRequest&&!u.emailInvalid){T(`S tímto e-mailem byl trial již požádán. Další žádost můžete podat od ${u.cooldownDateStr}.`);return}if(!He(t.email.trim())){T(Qe);return}Z(!0),T("");try{const A=await(await fetch(`${Ve}/validate-email?email=${encodeURIComponent(t.email.trim())}`,{headers:{Authorization:`Bearer ${fe}`}})).json();if(!A.ok){T(typeof A.message=="string"?A.message:Qe);return}const H=Jt(t),q=await _t(H);if(q.status==="error"){T(q.message);return}J(q)}catch($){T($ instanceof Error?$.message:"Odeslání se nezdařilo.")}finally{Z(!1)}}};return s?e.jsxs("div",{className:"w-full mt-6 pt-6 border-t border-[#001161]/10 text-left",children:[e.jsx("p",{style:Q,className:"text-[14px] font-bold text-[#001161] mb-2",children:"Zkusit Vividbooks zdarma"}),e.jsx("p",{style:Q,className:"text-[13px] text-[#001161]/65 leading-relaxed mb-4",children:"Pro 14denní přístup potřebujeme název školy a IČO. Vyplněte prosím zkušební formulář."}),e.jsx(wt,{to:"/vyzkousejte",className:"inline-flex items-center justify-center gap-2 rounded-xl bg-[#7C3AED] px-5 py-3 font-bold text-[14px] text-white shadow-lg shadow-[#7C3AED]/25 transition-all hover:scale-[1.02] hover:bg-[#6D28D9] no-underline",style:Q,children:"Přejít na zkušební přístup"})]}):b?.status==="codes"?e.jsx(U.div,{initial:{opacity:0,y:8},animate:{opacity:1,y:0},className:"w-full mt-6 pt-6 border-t border-[#001161]/10 text-left",children:e.jsxs("div",{className:"rounded-[20px] border border-green-200 bg-[#F0FDF4] p-6",children:[e.jsx(dt,{className:"mx-auto mb-3 h-10 w-10 text-green-500"}),e.jsx("h3",{className:"mb-2 text-center font-['Cooper_Light',serif] text-[22px] text-[#001161]",children:"Zkušební přístup"}),e.jsx("p",{style:Q,className:"mb-5 text-center text-[13px] text-[#001161]/70 leading-snug",children:b.kind==="existing_trial"?"Vaše škola už má aktivní zkušební přístup. Pro přihlášení použijte tyto kódy:":"Vaše přístupové kódy pro zkušební verzi:"}),e.jsxs("div",{className:"mx-auto grid max-w-md grid-cols-1 gap-3 sm:grid-cols-2",children:[e.jsxs("div",{className:"rounded-[14px] border border-[#001161]/10 bg-white px-4 py-3 shadow-sm",children:[e.jsx("p",{style:Q,className:"mb-1 text-[11px] font-bold uppercase tracking-wide text-[#001161]/45",children:"Kód pro učitele"}),e.jsx("p",{style:Q,className:"font-mono text-[17px] font-bold tracking-wide text-[#001161] break-all",children:b.teacherCode})]}),e.jsxs("div",{className:"rounded-[14px] border border-[#001161]/10 bg-white px-4 py-3 shadow-sm",children:[e.jsx("p",{style:Q,className:"mb-1 text-[11px] font-bold uppercase tracking-wide text-[#001161]/45",children:"Kód pro žáka"}),e.jsx("p",{style:Q,className:"font-mono text-[17px] font-bold tracking-wide text-[#001161] break-all",children:b.studentCode})]})]}),e.jsxs("a",{href:"https://app.vividbooks.com",target:"_blank",rel:"noopener noreferrer",className:"mt-5 flex w-full items-center justify-center gap-2 rounded-xl bg-[#7C3AED] px-6 py-3.5 text-[15px] font-bold text-white shadow-lg shadow-[#7C3AED]/25 transition-all hover:scale-[1.02] hover:bg-[#6D28D9] no-underline",style:Q,children:[e.jsx(Rt,{className:"h-4 w-4 shrink-0","aria-hidden":!0}),"Otevřít aplikaci"]}),e.jsx(Pt,{compact:!0,sectionClassName:"mt-5 border-t border-green-200/70 pt-5"})]})}):b?.status==="thank_only"?e.jsx("div",{className:"w-full mt-6 pt-6 border-t border-[#001161]/10 text-left",children:e.jsx("p",{style:Q,className:"text-[14px] text-[#001161]/75 leading-relaxed",children:"Děkujeme za žádost. Ozveme se vám co nejdříve s přístupovými údaji na e-mail."})}):e.jsxs("div",{className:"w-full mt-6 pt-6 border-t border-[#001161]/10 text-left space-y-4",children:[e.jsxs("div",{children:[e.jsx("h3",{style:Q,className:"text-[16px] font-bold text-[#001161] mb-1",children:"Vyzkoušejte Vividbooks"}),e.jsx("p",{style:Q,className:"text-[13px] text-[#001161]/60 leading-relaxed",children:C?"Máte přístup do Vividbooks? Ve vaší škole už digitální učebnice využívají kolegové. Kontakt a případné kódy najdete níže.":g?"Vaše škola nedávno žádala o zkušební přístup. Možnosti máte níže.":"Máte zájem o 14denní přístup k digitálním učebnicím? Stačí jeden klik — stejně jako u zkušebního formuláře vám přijde potvrzení a přístupové kódy."})]}),e.jsx(Et,{readOnly:!0,schoolName:t.schoolName,ico:S,onSelect:()=>{},onIcoChange:()=>{},pdStatus:o,pdMessage:l,pdLoading:E,colleagues:L,owner:N,products:z,hidePipedriveStatusCard:g}),g&&e.jsxs(U.div,{initial:{opacity:0,y:-4},animate:{opacity:1,y:0},className:"overflow-hidden rounded-2xl border border-amber-200 bg-amber-50/90",children:[e.jsxs("div",{className:"flex items-center gap-2.5 px-4 pt-4 pb-2",children:[e.jsx(At,{className:"h-4 w-4 shrink-0 text-amber-600","aria-hidden":!0}),e.jsx("p",{style:Q,className:"text-[14px] font-bold text-amber-900",children:"Tato škola dostala přístup nedávno"})]}),e.jsx("div",{className:"space-y-3 px-4 pb-4",children:e.jsxs("div",{className:"space-y-2.5 rounded-xl border border-amber-200/80 bg-white/70 px-3.5 py-3",children:[e.jsx("p",{style:Q,className:"m-0 text-[13px] text-[#001161]/80 leading-relaxed",children:"Zkušební přístupy vydáváme každé škole jednou za šest měsíců."}),v&&e.jsxs("p",{style:Q,className:"m-0 text-[12px] text-amber-900",children:["Další žádost z formuláře bude možná od ",e.jsx("span",{className:"font-bold",children:v.dateStr}),v.daysLeft>0?e.jsxs(e.Fragment,{children:[" (","za ",e.jsx("span",{className:"font-semibold text-[#001161]",children:v.daysLeft})," dní)."]}):"."]}),e.jsxs("p",{style:Q,className:"m-0 text-[12px] text-[#001161]/70",children:["Potřebujete dřív? Napište na ",e.jsx("a",{href:"mailto:hello@vividbooks.com",className:"font-bold text-amber-900 underline underline-offset-2",children:"hello@vividbooks.com"}),N?.name?` (${N.name})`:"","."]})]})})]}),!C&&!g&&e.jsxs("div",{className:"space-y-2",children:[e.jsx("button",{type:"button",onClick:h,disabled:W||!t.gdpr||!!u&&!u.canRequest,className:"flex w-full items-center justify-center gap-2 rounded-xl bg-[#7C3AED] px-5 py-3.5 text-[15px] font-bold text-white shadow-lg shadow-[#7C3AED]/25 transition-all hover:scale-[1.02] hover:bg-[#6D28D9] disabled:cursor-not-allowed disabled:opacity-50",style:Q,children:W?e.jsxs(e.Fragment,{children:[e.jsx(ce,{className:"h-4 w-4 animate-spin"}),"Odesílám…"]}):"Chci přístup"}),e.jsxs("div",{className:"flex items-center justify-center gap-2 min-h-[20px]",children:[I&&e.jsx(ce,{className:"h-3.5 w-3.5 animate-spin text-[#001161]/35"}),u?.emailInvalid&&u.message&&e.jsx("p",{style:Q,className:"text-[12px] text-red-700 text-center",children:u.message}),u&&!u.canRequest&&!u.emailInvalid&&e.jsxs("p",{style:Q,className:"text-[12px] text-amber-800 text-center",children:["S tímto e-mailem byl trial již požádán. Další od ",u.cooldownDateStr,"."]})]})]}),G&&e.jsxs("div",{className:"flex items-start gap-2 rounded-xl border border-red-200 bg-red-50 px-4 py-3",children:[e.jsx(pt,{className:"mt-0.5 h-4 w-4 shrink-0 text-red-500"}),e.jsx("p",{style:Q,className:"text-[13px] text-red-700",children:G})]}),e.jsx("p",{style:Q,className:"text-[11px] text-[#001161]/40",children:"Souhlas se zpracováním údajů z registrace na webinář se vztahuje i na tuto žádost o zkušební přístup."})]})}const Yt=`https://${je}.supabase.co/functions/v1/make-server-93a20b6f`,oe={fontFamily:"'Fenomen Sans', sans-serif"},Ze={fontFamily:"'Cooper Light', serif"},Kt=4,Xt=`
    @font-face {
