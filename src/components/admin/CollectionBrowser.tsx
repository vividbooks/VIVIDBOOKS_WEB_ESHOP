...
const HERO_SLIDE_FIELDS: FieldDef[] = [
  ...
  },
  {
    ...
    options: [
      ...
      { value: 'aplikace-video', label: 'Video Nová aplikace (WebM + nadpis)' },
  ...
  { key: 'bg', label: 'Barva pozadí', type: 'color' },
  {
    ...
    label: 'Video (WebM)',
    type: 'text',
    hint: 'Jen layout „Video Nová aplikace“. Výchozí /aplikace/hero.webm',
    showIf: (d) => d.layout === 'aplikace-video',
  },
  {
    key: 'heroVideoPoster',
    label: 'Poster videa',
    type: 'text',
    hint: 'Statický snímek při načítání / prefers-reduced-motion. Výchozí /aplikace/hero-cards.png',
    showIf: (d) => d.layout === 'aplikace-video',
  },
  {
    key: 'heroVideoPlaybackRate',
    label: 'Rychlost videa',
    type: 'number',
    hint: '1 = normální, 0.6 = pomaleji. Jen layout video Nová aplikace.',
    showIf: (d) => d.layout === 'aplikace-video',
  },
  {
    key: 'heroTextColor',
