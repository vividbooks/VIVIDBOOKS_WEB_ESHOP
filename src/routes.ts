  ...
  withLazyHydrateFallbacks([
    ...
    },
    {
      ...
      children: [
        ...
        { path: 'kampane', lazy: lazyDefault(() => import('./components/admin/MailingCampaignsPage')) },
        { path: 'automatizace', lazy: lazyDefault(() => import('./components/admin/MailingAutomationsPage')) },
      ],
    },
    ],
  },
